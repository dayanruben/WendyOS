...
type GpuStats struct {
	...
	// Per-GPU memory. Unset when the sampler cannot report it — e.g. Jetson
	// unified memory, where nvidia-smi answers "[N/A]" (the GPU shares host
	// RAM). Unset means "not applicable", which is different from 0.
	MemUsedBytes  *int64   `protobuf:"varint,4,opt,name=mem_used_bytes,json=memUsedBytes,proto3,oneof" json:"mem_used_bytes,omitempty"`
	MemTotalBytes *int64   `protobuf:"varint,5,opt,name=mem_total_bytes,json=memTotalBytes,proto3,oneof" json:"mem_total_bytes,omitempty"`
...
const file_wendy_agent_services_v1_wendy_agent_v1_container_service_proto_rawDesc = "" +
	...
	"\x06temp_c\x18\x02 \x01(\x01R\x05tempC\"\xa7\x02\n" +
	"\bGpuStats\x12\x14\n" +
	"\x05index\x18\x01 \x01(\rR\x05index\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12!\n" +
	"\futil_percent\x18\x03 \x01(\x01R\vutilPercent\x12)\n" +
	"\x0emem_used_bytes\x18\x04 \x01(\x03H\x00R\fmemUsedBytes\x88\x01\x01\x12+\n" +
	"\x0fmem_total_bytes\x18\x05 \x01(\x03H\x01R\rmemTotalBytes\x88\x01\x01\x12\x1a\n" +
	"\x06temp_c\x18\x06 \x01(\x01H\x02R\x05tempC\x88\x01\x01\x12\x1c\n" +
	"\apower_w\x18\a \x01(\x01H\x03R\x06powerW\x88\x01\x01B\x11\n" +
	"\x0f_mem_used_bytesB\x12\n" +
	"\x10_mem_total_bytesB\t\n" +
	"\a_temp_cB\n" +
	"\n" +
	"\b_power_w\"~\n" +
