...
- Read the [Raspberry Pi 5 Installation](/docs/installation/wendyos-raspberry-pi-5) or [NVIDIA Jetson Installation](/docs/installation/wendyos-nvidia-jetson) guides if you also work with larger devices
