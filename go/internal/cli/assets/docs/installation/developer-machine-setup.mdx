...
- **[Install Wendy Agent on macOS](/docs/installation/wendy-agent-macos)** if you want to deploy, manage, and debug Apple Silicon Mac targets; headless Mac systems are a good fit.
