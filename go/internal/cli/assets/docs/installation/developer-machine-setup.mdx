...
The `wendy` CLI is your developer tool for building, discovering, and deploying apps to Wendy devices. It helps set up WendyOS on NVIDIA Jetson and Raspberry Pi, and can target [Wendy Agent for Mac](/docs/installation/wendy-agent-macos) beta on Apple Silicon Macs.
...
- **[Install Wendy Agent on macOS](/docs/installation/wendy-agent-macos)** if you want to deploy native macOS apps to Apple Silicon Mac targets in beta; headless Mac mini systems are a good fit.
