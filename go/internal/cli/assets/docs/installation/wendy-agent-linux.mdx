...
`wendy-agent` comes pre-installed on WendyOS, which currently supports the [NVIDIA Jetson Orin Nano](/docs/installation/wendyos-nvidia-jetson) plus the [Raspberry Pi 5, 4, and 3](/docs/installation/wendyos-raspberry-pi-5). If you flashed WendyOS onto your device, you do not need to follow this guide.
