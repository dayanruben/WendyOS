...
The system sidecar uses the stock `ros:humble-ros-base` image with Fast DDS and
UDP discovery. The device downloads the image on first use and caches it for
