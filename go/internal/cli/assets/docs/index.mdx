...
<Cards className="grid-cols-2 lg:grid-cols-3">
  ...
  <div className="relative flex flex-col">
    ...
    <Card icon={<Terminal />} title="Wendy for Mac" className="h-full">
      Deploy native macOS apps to Apple Silicon Mac targets with [Wendy for Mac](/docs/installation/wendy-agent-macos) beta. Supports SwiftPM and Xcode projects with the same CLI workflow.
    </Card>
  </div>
