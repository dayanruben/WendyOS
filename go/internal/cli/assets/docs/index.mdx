...
<Cards>
  ...
  <div className="relative">
    ...
    <Card icon={<Terminal />} title="Wendy for Mac">
      Deploy native macOS apps to Apple Silicon Mac targets with [Wendy Agent for Mac](/docs/installation/wendy-agent-macos) beta. Supports SwiftPM and Xcode projects with the same CLI workflow.
    </Card>
  </div>
