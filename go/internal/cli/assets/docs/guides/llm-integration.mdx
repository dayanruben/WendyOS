...
- [Discover your devices](/docs/guides/device/discovering-devices)
- [Manage apps](/docs/guides/device/managing-apps)
- [Understand entitlements](/docs/guides/device/entitlements)
