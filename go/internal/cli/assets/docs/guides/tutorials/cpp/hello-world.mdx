...
- Build out the API in the [Simple Web Server](/docs/guides/tutorials/cpp/simple-web-server) guide
- Stream a camera feed with the [Camera Feed](/docs/guides/tutorials/cpp/camera) guide
