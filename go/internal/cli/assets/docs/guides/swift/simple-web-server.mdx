...
<Callout type="warning">
  **Important**: It's important that your Hummingbird server is running on `0.0.0.0` and not `localhost` or `127.0.0.1`. This is because your WendyOS device is not on the same network as your development machine. You'll need to access your server from the outside world, and `0.0.0.0` is the same as localhost but it's accessible from the outside world.
</Callout>
